          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full border border-gray-400 rounded p-3"
              />
            </div>
            <div>
              <label
            ...
            <button
              type="submit"
              className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 via-green-500 to-yellow-500 text-white font-semibold"
            >
              Submit
            </button>
          </form>
