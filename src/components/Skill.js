...
export default function Skill() {
  ...
  const skills = {
    technical: [
      { name: "HTML", prof: 80 },
      { name: "JavaScript", prof: 35 },
      { name: "CSS", prof: 70 },
      { name: "Python", prof: 40 },
      { name: "JavaScript", prof: 35 },
      { name: "C Language", prof: 89 },
    ],
    soft: [
      { name: "Communication", prof: 70 },
      { name: "Leadership", prof: 55 },
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="h-2 bg-gray-200 rounded-full">
                  <div
                    className="h-full bg-gradient-to-r from-blue-500 via-green-500 to-yellow-500 rounded-full transition-all duaration-200"
